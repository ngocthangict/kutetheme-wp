...
function kt_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', THEME_LANG ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', THEME_LANG ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', THEME_LANG ),
		'section'     => 'colors',
	) ) );
...
function kt_color_scheme_css() {
	...
	$color_textcolor_rgb         = kt_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = kt_hex2rgb( $color_scheme[4] );
	$colors = array(
